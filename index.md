...
|-------------|-------------|----------|----------|
{% for doc in site.active %}{% if doc.path contains 'syllabus' %} | {{ doc.course_code }} | {{ doc.course_name }} | [Syllabus 📄]({{ doc.url | relative_url }}) | [Calendar 📅]({{ site.baseurl }}/{{ doc.course_code }}-calendar.html) |
{% endif %}{% endfor %}